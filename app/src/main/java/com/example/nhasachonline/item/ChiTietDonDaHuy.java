...
public class ChiTietDonDaHuy {
    ...
    public ChiTietDonDaHuy() {
    }

    public ChiTietDonDaHuy(String maDonHang, String tenKhachHang, String tenNhanVienDuyet, String tenNhanVienGiao, String thoiGianLap, int phiVanChuyen, int giamGia, String diaChiGiao, String hinhThucThanhToan, String trangThaiDon, int tongTienThanhToan, String lyDoHuy) {
        this.maDonHang = maDonHang;
        this.tenKhachHang = tenKhachHang;
        this.tenNhanVienDuyet = tenNhanVienDuyet;
        this.tenNhanVienGiao = tenNhanVienGiao;
